...
uint8_t MacAddress::byteFromHexPair(char c1, char c2) { return hexToInt(c1) * 16 + hexToInt(c2); }
...
uint8_t& MacAddress::operator[](std::size_t idx) { return internal_.bytes_[idx]; }

const uint8_t& MacAddress::operator[](std::size_t idx) const { return internal_.bytes_[idx]; }
