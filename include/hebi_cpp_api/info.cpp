...
Info::FloatField::FloatField(HebiInfoPtr internal, HebiInfoFloatField field) : internal_(internal), field_(field) {}

bool Info::FloatField::has() const { return (hebiInfoGetFloat(internal_, field_, nullptr) == HebiStatusSuccess); }
...
Info::BoolField::BoolField(HebiInfoPtr internal, HebiInfoBoolField field) : internal_(internal), field_(field) {}

bool Info::BoolField::has() const { return (hebiInfoGetBool(internal_, field_, nullptr) == HebiStatusSuccess); }
...
Info::FlagField::FlagField(HebiInfoPtr internal, HebiInfoFlagField field) : internal_(internal), field_(field) {}

bool Info::FlagField::has() const { return (hebiInfoGetFlag(internal_, field_) == 1); }

Info::LedField::LedField(HebiInfoPtr internal, HebiInfoLedField field) : internal_(internal), field_(field) {}
